                        ...
                        {paymentMethods.length > 0 ? (
                            paymentMethods.map((method) => (
                                <StyledTableRow key={method.id}>
                                    ...
                                    <TableCell sx={{ minWidth: "200px", padding: "6px 12px", borderRight: "1px solid #ddd" }}>{method.provider}</TableCell>
                                    <TableCell sx={{ padding: "6px 12px", borderRight: "1px solid #ddd" }}>{method.maskedNumber}</TableCell>
                                    <TableCell sx={{ padding: "6px 12px", borderRight: "1px solid #ddd" }}>{method.details}</TableCell>
