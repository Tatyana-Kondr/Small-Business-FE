...
import { NewPurchaseDto } from "../types";
...
export default function Purchases() {
  ...
  const handleOpenCreatePurchaseModal = () => setOpenCreatePurchaseModal(true);
  const handleCloseCreatePurchaseModal = () => setOpenCreatePurchaseModal(false);

  const handleCreatePurchase = (newPurchase: NewPurchaseDto) => {
      dispatch(addPurchase(newPurchase));
      handleCloseCreatePurchaseModal();
    };
  ...
  return (
    <Container>
      ...
      <Button variant="contained" onClick={handleOpenCreatePurchaseModal}>
        Neue Bestellung
      </Button>
      ...
      {/* Модальное окно для создания покупки */}
            <CreatePurchaseModal
              open={openCreatePurchaseModal}
              handleClose={handleCloseCreatePurchaseModal}
              handleCreateProduct={handleCreatePurchase}
            />
    </Container>
  );
}
